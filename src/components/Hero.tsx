...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] w-full max-w-[100vw] flex items-center justify-center overflow-hidden section-padding pt-20 xs:pt-24 pb-20 snap-start touch-pan-y">
      ...
      {isMobile ? (
        ...
        <div className="absolute inset-0 w-full h-[100dvh] max-w-[100vw] overflow-hidden touch-pan-y">
          {videoFailed ? (
            <MobileHeroImage />
          ) : (
            <>
